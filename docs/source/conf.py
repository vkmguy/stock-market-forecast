...
# stock_market_forecast documentation build
...
from stock_market_forecast import __version__ as release

# -- Project information -----------------------------------------------------

project = "stock_market_forecast"
author = "Kedro"
...
htmlhelp_basename = "stock_market_forecastdoc"
...
latex_documents = [
    (
        master_doc,
        "stock_market_forecast.tex",
        "stock_market_forecast Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "stock_market_forecast",
        "Project stock_market_forecast codebase.",
        "Data-Science",
    )
]
